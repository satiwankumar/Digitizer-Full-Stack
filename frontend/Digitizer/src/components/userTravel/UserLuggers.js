...
import { UserLuggersByID, SortActionLugger } from '../../actions/lugger';
import Pagination from '../paginate/paginate';
import LuggerItem from './userLuggerItem';
...
const UserLuggersReport = ({ UserLuggersByID, lugger: { current_user_luggers, loading } ,history,match}) => {
      ...
      {loading ? (
        <Spinner />
          ...
          <Fragment>
           ...
           Object.keys(current_user_luggers).length > 0 ? (
            current_user_luggers.data.map((lugg,index) => (
              <LuggerItem
              key={lugg._id}
              lugger={lugg}
              index={index}
...
UserLuggersReport.propTypes = {
  getUserLuggers: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { UserLuggersByID, SortActionLugger })(UserLuggersReport)