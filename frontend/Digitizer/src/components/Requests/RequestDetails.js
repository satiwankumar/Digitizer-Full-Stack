...
import { getLuggerById } from '../../actions/lugger';




const RequestDetails = ({ getLuggerById,lugger:{lugger} , match,history }) => {
  useEffect(() => {
...
export default connect(mapStateToProps, { getLuggerById ,UpdateluggerStatus})(RequestDetails);
