...
import UserLuggersReport from '../userTravel/UserLuggers'
  ...
  return (
    <section >
      ...
      <Switch>
        ...
        <PrivateRoute exact path="/register" component={AddUser}/>
        ...
        <PrivateRoute exact path="/users/:id/luggers" component={UserLuggersReport}/>
        <PrivateRoute exact path="/users/:id/bookings" component={userBooking}/>
